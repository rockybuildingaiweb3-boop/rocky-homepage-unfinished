// GLSL shaders for Studio scroller warping and RGB split distortion effect
// Ported directly from the primary reference implementation
...
export function getFragmentShaders() {
	...
	function buildShader(fragmentSnippet: string) {
		return `
	...
	return {
		horizontal: buildShader(horizontal),
		vertical: buildShader(vertical),
	};
}
